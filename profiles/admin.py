...
class CustomAdminSite(admin.AdminSite):
    site_header = 'RatingSite Admin'
    site_title = 'RatingSite Admin Portal'
    index_title = 'Welcome to RatingSite Dashboard'
...
class CustomUserAdmin(BaseUserAdmin):
    ...
    def get_queryset(self, request):
        ...
        return qs.annotate(
            ...
            fan_vote_count=Count('fanfavoritevote', distinct=True),  # ✅ Fixed
        )
...
admin_site.register(User, CustomUserAdmin)  # ✅ Register User model here
